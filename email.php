	...
	<body>
		<div class="container login-container" itemscope>
			<div class="login-card">
				...
				<div class="login-acesse">O e-mail não está cadastrado!</div>
				<div class="login-acesse">Contate-nos: (47) 3404-5300.</div>
				<div class="login-esqueceu-senha">Ou através do e-mail ti@noxgr.com.br.</div>
				<div class="login-btn-box"><a href="index.php"><button type="submit">Voltar</button></a></div>
